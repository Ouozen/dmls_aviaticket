...
@dag(default_args=default_args, catchup=False, schedule_interval="50 19 * * *")
def weather_parsing_yesterday():
    ...
    filename = save_weather(yesterday, base_url, api_key, unit_group, location, include)
    insert(filename)


weather_parsing_yesterday = weather_parsing_yesterday()