...
@dag(default_args=default_args, catchup=False, schedule_interval="0 20 * * *")
def online_parsing_yesterday():
    def open_page(url):
    ...
    filename = save_flights(urls_yesterday)
    insert(filename)

online_parsing_yesterday = online_parsing_yesterday()
